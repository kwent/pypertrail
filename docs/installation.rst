...
The sources for pypertrail can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/kwent/pypertrail
.. _tarball: https://github.com/kwent/pypertrail/tarball/master
